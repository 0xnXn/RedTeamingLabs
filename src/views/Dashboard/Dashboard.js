...
export default function Dashboard() {
  ...
  const redirect_access = () => {
    history.push('/admin/access')
  }
  const redirect_machine = () => {
    history.push('/admin/machine')
  }
  const redirect_learn = () => {
    history.push('/admin/learn')
  }
        ...
        <Row >
          <CardDeck>
            ...
            >
              ...
              <Card.Body>
                <Card.Title> VPN Connection </Card.Title>
                <div style={{ width: "100px", height: "100px", marginLeft: "30%" }} onClick={redirect_access}>
            ...
            >
              <Card.Body>
                ...
                <div style={{ width: "100px", height: "100px", marginLeft: "30%" }} onClick={redirect_machine}>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <div style={{ width: "100px", height: "100px", marginLeft: "30%" }} onClick={redirect_learn}>
          ...
          <Col>
            <CardDeck style={{ marginTop: "20px" }}>
              ...
              >
                ...
                <Card.Body>
                  <Card.Title ><div style={{ fontSize: "15px", textAlign: "center" }}>Machine Available</div></Card.Title>
                  <Card.Text>

                    <svg version="1.1" id="Capa_1" x="0px" y="0px" width="50px" height="50px"
                      viewBox="0 0 490 490"  >
		...
		h123.1v46.2h111.8v-46.2h132.8c5.4,0,9.7-4.3,9.7-9.7V112h46.2V0.1H489.4z"/>
          ...
          <Col >
            <div style={{ background: "#343a40" }}>
              <Table responsive="sm" style={{ color: "white", marginTop: "20px" }}>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Top Teams</th>
