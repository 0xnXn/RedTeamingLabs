...
import machine1 from '../images/machine1.svg';
import "./Machine.css"
            ...
            {(mainSpinner) ?
                ...
                /> */}
                    ...
                    <Container >
                            ...
                            <div className="pt-3">
                                ...
                                <Row>
                                    <Col style={{ width: "100%" }}>
                                        ...
                                        <embed src={machine1} height="300" style={{ float: "right" }}></embed>
                                    </Col>
                        ...
                        <Modal show={layout} onHide={layoutHide} size="lg" centered='false'
                        >
                            {/* <Modal.Header closeButton>
                    <Modal.Title>Layout Architecture </Modal.Title>
                </Modal.Header> */}
                            <Modal.Body>
                                <h2 style={{ color: "black" }}>Layout Architecture</h2>
                                <div>
                                    {
                                        (showImage) ?
                                            // <div>
